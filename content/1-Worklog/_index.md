...
| Graduation food-recipe project | Provided the domain, dataset context, and motivation for building a Vietnamese recipe assistant. | [Thesis reference](/files/evidence/thesis-reference.pdf), [private repo screenshot](/images/evidence/graduation-project-repo.png), and [Supporting Evidence](../8-SupportingEvidence/) |
