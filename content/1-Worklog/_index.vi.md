...
| Graduation food-recipe project | Cung cấp domain, dataset context, và motivation để xây Vietnamese recipe assistant. | [Thesis reference](/files/evidence/thesis-reference.pdf), [private repo screenshot](/images/evidence/graduation-project-repo.png), và [Bằng chứng hỗ trợ](../8-SupportingEvidence/) |
